...
namespace ReceiptSharp.Printers
{
    ...
    class Sii : Thermal
    {
        ...
        public override string Open(PrintOption printer)
        {
            ...
            return $"\u001b@\u001da\u0000\u001bM0\u001b \u0000\u001cS\u0000\u0000{(Spacing ? "\u001b2" : "\u001b3\u0000")}\u001b{{{(char)(UpsideDown ? 1 : 0)}\u001c.";
        }
        // finish printing: DC2 q n
        public override string Close()
        {
            return (Cutting ? Cut() : "") + "\u0012q\u0000";
        }
        ...
        public override string Area(int left, int width, int right)
        {
            ...
            Width = width;
            Right = right;
            int m = (UpsideDown ? MarginRight + right : Margin + left) * CharWidth;
        ...
        {
            string r = UpsideDown ? Area(Right, Width, Left) + Align(2 - Alignment) : "";
