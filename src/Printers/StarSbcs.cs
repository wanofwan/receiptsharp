...
namespace ReceiptSharp.Printers
{
    ...
    class StarSbcs : Star
    {
        ...
        public override string VrHr(int[] widths1, int[] widths2, int dl, int dr)
        {
            ...
            return $"\u001b\u001dt\u0001{string.Concat(r2.Select((c, i) => VrTable[c][r1[i]]))}";
        }
